...
function TrainShortDescription({ name, stations, photoUrl }) {
  return (
...
export default function BookingTrainTicket({
  id,
  classId,
  date,
  createdAt,
    ...
    <Grid
      ...
      <Grid item container justify='center' alignItems='center'>
        <Grid item xs container direction='column'>
          <Typography style={{ fontSize: '24px' }}>Vé tàu hỏa</Typography>
          <Grid container>
            <Grid item xs>
              <Typography>
